...
public class PaymentTerminal {
    ...
    public boolean eatAffordably(PaymentCard card) {
        ...
        // if the payment card has enough money, the balance of the card is decreased by the price, and 
    ...
    public double eatHeartily(double payment) {
        ...
        // if the payment parameter is not large enough, n moeal is sold and
        // the method should return the whole payment
        if(payment < 4.30){
            return payment;
        } else{
